...
class MangoDB:
        def __init__(self, collection ,key, item):
        
        
        def __update_collection__(self,collection, key, item):
...
def exercise03():
    ...
    # ------ Place code below here \/ \/ \/ ------
    import pandas as pd
    url = 'https://github.com/chainhaus/pythoncourse/blob/master/avocado.csv'
