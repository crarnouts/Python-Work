# -*- coding: utf-8 -*-
"""
Created on Mon Mar 11 19:59:25 2019
...
class PandasChain:
    ...
    def __commit_block(self,block): 
        block_hash = self.__block.get_simple_merkle_root # Create block hash
        self.__block.set_block_hash(block_hash)
        # Add code here
...
class Block:
    ...
    def display_header(self): 
        print("seq_id:", end = " ") 
        print(self.__seq_id, end = " ")
        print("status:", end = " ") 
        print(self.__status, end = " ")
        print("block_hash:", end = " ") 
        print(self.__prev_hash, end = " ")
        print("previous block_hash:", end = " ") 
        print(self.__block_hash, end = " ")
        print("merkle_hash:", end = " ") 
        print(self.__merkle_tx_hash, end = " ")
        print("Number of Transactions:", end = " ") 
        print(len(self.__transactions.index), end = " ")
        pass
