...
class Iris:
    ...
    def create(self):
        ...
        mycursor.execute("CREATE TABLE Iris (sepal_length FLOAT(10), sepal_width FLOAT(10), petal_length FLOAT(10), petal_width FLOAT(10))")
    ...
    def load(self,truncate=False):
        ...
        mycursor = self.__conn.cursor()
        for i in range(3):
            sqlFormula = "INSERT INTO Iris (sepal_length,sepal_width,petal_length,petal_width) VALUES (%s,%s,%s,%s)"
            line = ('7.2', '3.6','6.1', '2.5')
            #line = data[0]
