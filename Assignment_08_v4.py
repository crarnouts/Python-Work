...
class Iris:
    ...
    def create(self):
        ...
        mycursor.execute("CREATE TABLE Iris (id INT(10),sepal_length FLOAT(10), sepal_width FLOAT(10), petal_length FLOAT(10), petal_width FLOAT(10), target_species_id INT(10))")
    ...
    def load(self,truncate=False):
        ...
        for i in range(data.shape[0]):
            sqlFormula = "INSERT INTO Iris (id,sepal_length,sepal_width,petal_length,petal_width,target) VALUES (%s,%s,%s,%s,%s,%s)"
            line = (str(i),str(data.iloc[i][0]), str(data.iloc[i][1]),str(data.iloc[i][2]), str(data.iloc[i][3]), str(data.iloc[i][4]))
            #line = data[0]
...
mycursor.execute("CREATE TABLE Iris (sepal_length INTEGER(10), sepal_width INTEGER(10), petal_length INTEGER(10), petal_width INTEGER(10))")
